...
\yearsminus{DP and F. Nobile, ``Inexpensive surrogate modeling of frequency response problems by greedy minimal rational interpolation'', GAMM Annual Meeting 2022, Aachen (D).}
