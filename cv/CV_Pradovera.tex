...
\yearsplus{2023}{Referee for scientific journals: ``Advances in Computational Mathematics'', ``Computational Methods in Applied Mathematics'', ``Journal of Computational Physics'', ``Inverse Problems'', and ``SIAM Journal of Scientific Computing''.}
...
\yearsplus{2024}{Referee for scientific journals: ``Advances in Computational Mathematics'', ``Applied Mathematics Letters'', ``Computational Methods in Applied Mathematics'', and ``Mathematics and Computers in Simulation''.}
