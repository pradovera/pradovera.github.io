...
\years{2021}{F. Bonizzoni, DP, and M. Ruggeri, ``Rational-based model order reduction of Helmholtz frequency response problems with adaptive finite element snapshots'', under review.}

\years{2022}{DP, ``Adaptive approximation of nonlinear eigenproblems by minimal rational interpolation'', accepted in PAMM 22.}
...
\subsection*{Others}\startseclist
...
\yearsplus{2022}{DP, ``Surrogate modeling of parametric frequency response problems via locally adaptive sparse grids'', workshop talk, ``Approx. of high-dim. param. PDEs in forward UQ'' ESI workshop, Vienna (A).}
...
\yyears{2017}{Analyse avanc\'ee I, \textsc{BSc} in Mathematics.}

\yyears{2018}{Analyse numerique, \textsc{BSc} in Mechanical Engineering.}

\yyears{2018}{Analyse fonctionnelle, \textsc{BSc} in Mathematics.}

\yyears{2019}{Introduction to partial differential equations, \textsc{BSc} in Mathematics.}

\yyears{2021}{Numerical analysis and computational mathematics, \textsc{MSc} in Computational Sciences and Engineering.}

\yyears{2019--2021}{Parallel and high-performance computing, \textsc{MSc} in Computational Sciences and Engineering.}
\egroup
