...
\yearsplus{2023}{DP, ``Adaptive approximation of nonlinear eigenproblems by minimal rational interpolation'', PAMM 22 (in press).}

\yearsminus{F. Bonizzoni, DP, and M. Ruggeri, ``Rational-approximation-based model order reduction of Helmholtz frequency response problems with adaptive finite element snapshots'', Math. Eng. XX (in press).}
