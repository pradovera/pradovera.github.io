...
\yearsminus{DP, ``Rational approximation with minimal sampling for Helmholtz-like problems'', ILAS 2023, Madrid (E).}
...
\yearsminus{Chairperson for ``Data-driven reduced order modelling and surrogates with applications in complex multi-physics systems'' mini-symposium at M2P 2023.}
