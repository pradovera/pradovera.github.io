...
\years{2012--2015}{\emph{\textsc{B.Sc.} in Applied Mathematics} (\emph{cum laude}), Politecnico di Milano, Milan (I).\\
...
\yearsplus{2019}{DP, F. Nobile, F. Bonizzoni, and I. Perugia, ``A technique for rational model order reduction of parametric problems lacking uniform inf-sup stability'', GAMM 2019, Vienna (A).}
...
\years{2022}{DP, ``Surrogate modeling of parametric frequency response problems via locally adaptive sparse grids'', workshop talk, ``Approx. of high-dim. param. PDEs in forward UQ'' ESI workshop, Vienna (A).}
...
\years{2017}{Analyse avanc\'ee I, Mathematics, EPFL.}
...
\years{2019}{Supervision of B.Sc. thesis: ``Approximation num\'erique du spectre des op\'erateurs elliptiques d'ordre deux'' by T. Chanay, EPFL.}
