...
\yearsminus{DP, ``Adaptive approximation of nonlinear eigenproblems by minimal rational interpolation'', PAMM 22.}
...
\yearszero{DP, ``Toward a certified greedy Loewner framework with minimal sampling'', under review.}
