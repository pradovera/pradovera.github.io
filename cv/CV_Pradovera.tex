...
\yearsplus{2023}{Referee for scientific journals: ``Computational Methods in Applied Mathematics'', ``Journal of Computational Physics'', and ``Inverse Problems''.}
...
\yearsminus{Organizer for ``Reducing the irreducible: model reduction for transport-dominated problems'' mini-symposium at ENUMATH 2023.}
