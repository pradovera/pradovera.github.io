...
\yearsplus{2023}{DP, M. Nonino, and I. Perugia, ``Geometry-based approximation of waves propagating through complex domains'', 17\textsuperscript{th} Austrian Numerical Analysis Day, Vienna (A).}

\yearszero{DP, F. Nobile, and A. Borghi, ``Non-intrusive surrogate modeling of parametric frequency-response problems'', Math2Product 2023, Taormina (I).}

\yearszero{DP, ``Rational approximation with minimal sampling for Helmholtz-like problems'', ILAS 2023, Madrid (E).}

\yearsminus{DP, F. Nobile, and A. Borghi, ``Data-driven adaptive approximation of parametric dynamical systems with pole bifurcations'', ENUMATH 2023, Lisbon (P).}
...
\years{2023}{DP, ``Efficient and adaptive rational approximation for parametric dynamical systems'', seminar, CSC seminar, Magdeburg (D).}
