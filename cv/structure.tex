...
\newlength{\tikzbracketshift}\setlength{\tikzbracketshift}{-1mm}
\newlength{\tikzbracketwidth}\setlength{\tikzbracketwidth}{.75mm}
\newlength{\tikzbracketheight}\setlength{\tikzbracketheight}{3.75mm}
\newcommand{\years}[1]{\strut\marginnote{{\scriptsize #1}~~\raisebox{\tikzbracketshift}{\tikz \draw (\tikzbracketwidth,0) -- (0,0) -- (0,\tikzbracketheight) -- (\tikzbracketwidth,\tikzbracketheight);}}}
\newcommand{\yearsplus}[1]{\strut\marginnote{{\scriptsize #1}~~\raisebox{\tikzbracketshift}{\tikz \draw (0,0) -- (0,\tikzbracketheight) -- (\tikzbracketwidth,\tikzbracketheight);}}}
\newcommand{\yearszero}{}%\strut\marginnote{\raisebox{\tikzbracketshift}{\tikz \draw (0,0) -- (0,\tikzbracketheight);}}}
\newcommand{\yearsminus}{\strut\marginnote{\raisebox{\tikzbracketshift}{\tikz \draw (\tikzbracketwidth,0) -- (0,0) -- (0,\tikzbracketheight);}}}
\newcommand{\yyears}[1]{\strut\marginnote{{\scriptsize #1~}$($}\hspace{2mm}}
