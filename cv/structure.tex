...
\newcommand{\years}[1]{\marginnote{\hspace{-\leftskip}\hfill\scriptsize #1~$[$}} % New command for adding years to the margin
\newcommand{\yearsplus}[1]{\marginnote{\hspace{-\leftskip}\hfill\scriptsize #1~\raisebox{1pt}{$\lceil$}}} % New command for adding years to the margin
\newcommand{\yearsminus}{\marginnote{\hspace{-\leftskip}\hfill\scriptsize \raisebox{-1pt}{$\lfloor$}}} % New command for adding years to the margin
